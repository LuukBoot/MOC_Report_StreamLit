...
# Configure the page
st.set_page_config(page_title="Secure MOC Report App",
                   page_icon="🔒", layout="wide")

# Define allowed users (whitelist)
ALLOWED_USERS = [
    "luuk.boot@gmail.com",
    "Martin3233@icloud.com",
    ...
    with col2:
        ...
        with st.expander("ℹ️ Authentication Info"):
            ...
            if "localhost" in redirect_uri:
                ...
                st.success(
                    "🌐 Running in **Production** mode on Streamlit Cloud")
...
def main():
    ...
    if 'user_info' in st.session_state:
        ...
        if user_email not in ALLOWED_USERS:
            ...
            st.error(
                f"User {user_email} is not authorized to access this application.")
